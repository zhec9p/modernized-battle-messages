  ...
  class Move
    module ZVBattleMsgProcedure
      def efficent_message(effectiveness, target)
        return super unless ZVBattleMsg.replace_effectiveness?
      ...
      def hit_criticality_message(actual_targets, target)
        return super unless ZVBattleMsg.replace_critical_hit?
      ...
      def accuracy_immunity_test(user, targets)
        return super unless ZVBattleMsg.replace_unaffected?
      ...
      def proceed_move_accuracy(user, targets)
        return super unless ZVBattleMsg.replace_miss?
